...
### 🔹 **Lab-3: Script-Driven Synthesis**
Enhance synthesis automation:
- Constraint scripting
- Gate-level netlist generation

### 🔹 **Lab-4: Datapath + Control Design**
Build complex logic:
...
### 🔹 **Lab-6: Verification & Physical Implementation**
End-to-end verification:
- Pre/Post-synthesis validation
- Physical design of a 2×2 multiplier
...
- **Cadence Innovus** — physical design (floorplanning, CTS, routing)
